...
# data_paths="${REPO_HOME}/dataset/ReferringImageCaptioning/processed/ric_instances_train2017.json" 
data_paths="PaDT-MLLM/ReferringImageCaptioning/ric_instances_train2017.json"
image_folders="${REPO_HOME}/dataset/coco/train2017"

model_path="Qwen/Qwen2.5-VL-3B-Instruct"
echo "data_paths: $data_paths"
echo "image_folders: $image_folders"

export EXP_NAME="PaDT-RIC-3B" # TODO: change this to your own experiment name
