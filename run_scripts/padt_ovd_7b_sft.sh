...
# data_paths="${REPO_HOME}/dataset/coco/processed/instances_train2017.json" 
data_paths="PaDT-MLLM/COCO/instances_train2017.json"
...
export EXP_NAME="PaDT-OVD-7B" # TODO: change this to your own experiment name
